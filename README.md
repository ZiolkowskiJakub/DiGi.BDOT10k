...
**DiGi.BDOT10k** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.BDOT10k.Geometry](DiGi.BDOT10k.Geometry)** (Path: `DiGi.BDOT10k\DiGi.BDOT10k.Geometry`)
* **[DiGi.BDOT10k](DiGi.BDOT10k)** (Path: `DiGi.BDOT10k\DiGi.BDOT10k`)
